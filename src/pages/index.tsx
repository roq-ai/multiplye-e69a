...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Multiplye`}</title>

        <meta
          name="description"
          content="Welcome to Multiplye, your personal carbon accounting app. Transform your spending into environmental awareness, one csv upload at a time."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Multiplye, your personal carbon accounting app. Transform your spending into environmental awareness, one csv upload at a time.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXJib24lMjBhY2NvdW50aW5nJTJDc3BlbmRpbmd8ZW58MHx8fHwxNjg4NzE0NjA3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
