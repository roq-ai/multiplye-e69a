...
import { getCarbonAccountingById } from 'apiSdk/carbon-accountings';
...
function CarbonAccountingViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Carbon Accounting Detail View
          </Text>
          {hasAccess('carbon_accounting', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/carbon-accountings/edit/${data?.id}`} passHref legacyBehavior>
              <Button
